<div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1" data-keyboard="false" data-backdrop="static">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form class="avatar-form" action="{{urlFor('admin_deals_upload_source_logo')}}" enctype="multipart/form-data" method="POST">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title" id="avatar-modal-label">Change Deals Source Logo</h4>
            </div>
            <div class="modal-body">
              <div class="avatar-body">

              	<p>Select a source logo for the source identification</p>
